#This script installs SQL Server Management Studion (SSMS) 2016
# SSMS-Setup-2016.exe file will need to be copied to blob storage for this Artifact
